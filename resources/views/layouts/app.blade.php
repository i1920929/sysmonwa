...
<head>
    ...
    <title>{{ config('app.name', 'SYSMONWA') }}</title>
...
<body>
    <div id="app">
        ...
        <header>
            <div class="logo">
                <a href="{{ url('/') }}">
                    <img src="{{ asset('img/logo.png') }}" alt="Logo de SYSMONWA">
                </a>
            </div>
        </header>
        ...
        <footer>
            <div class="container">
                <p>Copyright © 2024 SYSMONWA. Derechos Reservados</p>
            </div>
        </footer>
    </div>
</body>
